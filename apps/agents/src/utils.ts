...
export const getModelConfig = (
  ...
  if (customModelName.startsWith("bedrock/")) {
    const actualModelName = customModelName.replace("bedrock/", "");
    return {
      ...providerConfig,
      modelName: actualModelName,
...
export async function getModelFromConfig(
  ...
  return await initChatModel(modelName, result);
}
...
export function getRequirementsContext(requirementsAnalysis: RequirementsAnalysis | undefined) {
  return requirementsAnalysis
    ...
    `Please update the HTML, CSS, and JavaScript code to implement these requirements, focusing on creating a beautiful and interactive user interface.`
    : "";
}