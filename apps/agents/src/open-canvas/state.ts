...
export const OpenCanvasGraphAnnotation = Annotation.Root({
  ...
  /**
   * The analyzed requirements from user input.
   */
  analyzedRequirements: Annotation<RequirementsAnalysis | undefined>,
  /**
  ...
  /**
   * The generated Domain Specific Language (DSL) describing the web page structure and behavior.
   */
  webDSL: Annotation<any | undefined>,
});
